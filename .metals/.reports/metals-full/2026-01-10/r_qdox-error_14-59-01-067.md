error id: file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/RequireAnyRole.java
file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/RequireAnyRole.java
...
```java
offset: 205
uri: file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/RequireAnyRole.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/RequireAnyRole.java