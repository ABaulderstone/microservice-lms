error id: file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/decorators/RequireAnyRoleAspect.java:com/example/auth_service/common/exceptions/ForbiddenException#
file://<WORKSPACE>/auth-service/src/main/java/com/example/auth_service/common/decorators/RequireAnyRoleAspect.java
empty definition using pc, found symbol in pc: com/example/auth_service/common/exceptions/ForbiddenException#
...
import com.example.auth_service.common.exceptions.Forbidde@@nException;
